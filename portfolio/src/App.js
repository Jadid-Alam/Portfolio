...
function App() {
    ...
    const colorString = `rgb(${color.r}, ${color.g}, ${color.b})`;
                                                                        // add transition using a circle
  return (
    <div className={`App fade-in duration-1000 ease-in-out ${darkMode ? 'bg-gray-950' : 'bg-yellow-50'}`}> 
            ...
            <h4 className="p-1 max-w-40 md:p-2" style={{ color: colorString }}>Jadid Alam</h4>
              <nav className="mr-auto">
                <ul className="flex">
                    ...
                    hover:transform hover:transition ${darkMode ? 'text-purple-500' : 'text-black'}`}><a to='/Experience'>Experience</a></li>

                    <li className={`p-1 md:p-2 transform transition hover:text-purple-600 hover:translate-y-1 
                    hover:transform hover:transition ${darkMode ? 'text-purple-500' : 'text-black'}`}><a to="Projects">Projects</a></li>

                    <li className={`p-1 md:p-2 transform transition hover:text-purple-600 hover:translate-y-1 
                    hover:transform hover:transition ${darkMode ? 'text-purple-500' : 'text-black'}`}><a to="/Blog">Mini-Blog</a></li>
                </ul>
              </nav>
              ...
              <nav className="mr-1 items-end sm:mr-2 md:mr-4">
                <ul className="flex justify-end">
                    <li className={`p-1 md:p-2 transform transition hover:text-purple-600 hover:translate-y-1 hover:transform hover:transition
                        ${darkMode ? 'text-purple-500' : 'text-black'}`}><a className='FINISH THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS'>Resume</a></li>  
                    <li className={`p-1 md:p-2 transform transition hover:text-purple-600 hover:translate-y-1 hover:transform hover:transition
                        ${darkMode ? 'text-purple-500' : 'text-black'}`}><a to="/ContactMe">Contact Me</a></li>
